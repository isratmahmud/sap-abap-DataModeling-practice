CLASS zcl_2393_05_tys_structure DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*             name    TYPE st_name,
*             address TYPE zst_2393_05_s_address,
*           END OF st_person.
...
CLASS ZCL_2393_05_TYS_STRUCTURE IMPLEMENTATION.
...
*    DATA address TYPE st_address.
    Data address TYPE zst_2393_05_s_address.
...
*    DATA person TYPE st_person.
        DATA person Type zst_2393_05_s_person.
...
*    DATA person2 TYPE st_person_inc.
    DATA person2 TYPE zst_2393_05_s_person_inc.
